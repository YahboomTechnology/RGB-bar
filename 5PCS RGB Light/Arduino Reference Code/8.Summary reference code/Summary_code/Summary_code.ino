...
{
  RGB_Light_2(0, 255, 165, 0);
  delay(100);
  RGB_Light_2(1, 255, 165, 0);
  delay(100);
  RGB_Light_2(2, 255, 165, 0);
  delay(100);
  RGB_Light_2(3, 255, 165, 0);
  delay(100);
  RGB_Light_2(4, 255, 165, 0);
  delay(100);
  RGB_Light_2(4, 255, 165, 0);
  delay(100);
  RGB_OFF();
...
{
  uint8_t i = 0;
  R = map(R, 0, 255, 0, 200);  //这里可以通过映射改变亮度，如果觉得灯太亮了刺眼，就可以通过这里降低亮度
  G = map(G, 0, 255, 0, 200);
  B = map(B, 0, 255, 0, 200);
  uint32_t color = strip.Color(G, R, B);  //设置颜色
...
{ 
   RGB_Light_3(255,0 ,0);   //红
   delay(400);
   RGB_Light_3(0,255 ,0);    //绿
   delay(400);
   RGB_Light_3(0,0 ,255);    //蓝
   delay(400);
   RGB_Light_3(255,255 ,0);   //黄
   delay(400);
   RGB_Light_3(255,0 ,255);   //紫
   delay(400);
   RGB_Light_3(0,255,255);   //青
   delay(400);
   RGB_Light_3(255,255,255);  //白
   delay(400);
